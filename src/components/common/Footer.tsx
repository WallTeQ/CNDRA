      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-300 mb-4 max-w-md">
              Preserving our nation's historical documents and making them accessible to researchers, 
              government agencies, and the public for generations to come.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/search" className="text-slate-300 hover:text-white transition-colors">Search Archives</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-300 text-sm">700 Pennsylvania Ave, Washington, DC</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          <p className="text-slate-400 text-sm">
            © 2024 National Archive. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
