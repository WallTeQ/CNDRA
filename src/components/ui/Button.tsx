...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-slate-800 text-white hover:bg-slate-700 focus:ring-slate-500 shadow-sm hover:shadow-md',
    secondary: 'bg-slate-800 text-white hover:bg-slate-700 focus:ring-slate-500 shadow-sm hover:shadow-md',
    outline: 'border border-slate-300 text-slate-700 hover:bg-slate-50 focus:ring-slate-500 bg-white shadow-sm hover:shadow-md',
