    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-slate-800 to-slate-900 text-white">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&fit=crop)",
          }}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600">
                <p>
                  The National Archive serves as the cornerstone of our nation's
                  historical preservation efforts. For over a century, we have
                  been dedicated to collecting, preserving, and providing access
                  to the documents that tell the story of our country.
                </p>
                <p>
                ...
                <p>
                  ...
                  our archive provides the tools and resources you need to
